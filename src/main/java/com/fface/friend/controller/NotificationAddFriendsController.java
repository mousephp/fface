package com.fface.friend.controller;
...
import com.fface.friend.service.notificationAddfriends.NotificationAddFriendsServiceImpl;
...
@RestController
@CrossOrigin("*")
@RequestMapping("/api/addFriends")
public class NotificationAddFriendsController {
    @Autowired
    private NotificationAddFriendsServiceImpl notificationAddfriendsService;
